'''
This is the script used to generate the LwF-MC data of the figure of chapter 3.
...
if __name__ == "__main__":
    ...
    for i, (lr, s, d, w) in enumerate(combinations, start=1):
        ...
        cmd = f"python {main_path} --dataset seq-mnist --backbone mnistmlp --model lwf-mc  --lr {lr} --seed {s} --n_epochs {epochs} --mlp_hidden_size {w} --mlp_hidden_depth {d} --enable_other_metrics True"
        run_command(cmd)
